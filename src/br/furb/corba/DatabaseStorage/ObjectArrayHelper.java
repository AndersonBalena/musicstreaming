...
/**
* DatabaseStorage/ObjectArrayHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from idl
* Domingo, 22 de Maio de 2016 09h52min06s BRT
*/

abstract public class ObjectArrayHelper
{
  private static String  _id = "IDL:DatabaseStorage/ObjectArray:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (ObjectArrayHelper.id (), "ObjectArray", __typeCode);
    }
    return __typeCode;
  }
